...
client.playid = function playid(id, fn) {
  client.sendCommand('playid', [id], fn)
};
...
client.collection = function collection(fn) {
  client.sendCommand('listallinfo', function(err, data) {
    fn(err, parsing.playlist(data));
  });
};
